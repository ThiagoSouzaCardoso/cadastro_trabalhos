...
@Embeddable
public class AlunoTrabalhoId implements Serializable {

	private static final long serialVersionUID = 5351510729540535800L;
	...
	@Column(name="TRABALHO_ID",insertable=false,updatable=false)
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((idTrabalho == null) ? 0 : idTrabalho.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AlunoTrabalhoId other = (AlunoTrabalhoId) obj;
		if (idAluno == null) {
		...
		if (idDisciplina == null) {
			...
			return false;
		if (idTrabalho == null) {
			if (other.idTrabalho != null)
				return false;
		} else if (!idTrabalho.equals(other.idTrabalho))
			return false;
		return true;
	}
